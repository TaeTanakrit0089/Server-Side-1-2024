-- Insert RoomTypes
INSERT INTO bookings_roomtype (id, name, description)
VALUES (1, 'Conference', 'A room for holding conferences'),
       (2, 'Lecture', 'A lecture hall'),
       (3, 'Office', 'A personal office space');
SELECT setval('bookings_roomtype_id_seq', 3);

-- Insert Rooms
INSERT INTO bookings_room (id, number, name, capacity, description)
VALUES (1, '101', 'Main Conference Room', 50, 'Equipped with projector'),
...
INSERT INTO bookings_room_room_types (room_id, roomtype_id)
VALUES (1, 1), -- Main Conference Room has type Conference
...
-- Insert Staff
INSERT INTO bookings_staff (id, name, email, position)
...
-- Insert Bookings
INSERT INTO bookings_booking (id, staff_id, room_id, start_time, end_time, purpose)
VALUES (1, 1, 1, '2024-08-18 09:00:00', '2024-08-18 11:00:00', 'Monthly staff meeting'),
